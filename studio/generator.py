...
def generate_circle(num_drones: int, duration: float, rate: float) -> dict:
    total_steps = int(duration * rate)
    drones_wps = {d_id: [] for d_id in range(num_drones)}
    
    start_positions = {d_id: {"x": 0.0, "y": float(2.0 * d_id), "z": 0.0} for d_id in range(num_drones)}
...
def generate_helix(num_drones: int, duration: float, rate: float) -> dict:
    total_steps = int(duration * rate)
    drones_wps = {d_id: [] for d_id in range(num_drones)}
...
def generate_heart(num_drones: int, duration: float, rate: float) -> dict:
    total_steps = int(duration * rate)
    drones_wps = {d_id: [] for d_id in range(num_drones)}
...
def generate_cube(num_drones: int, duration: float, rate: float) -> dict:
